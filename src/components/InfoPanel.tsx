...
export default function DebugPanel({ ...props }: GroupProps) {
  ...
  const [isCountingDown, startRecording, startCountingDown] = useMainStore(
    (state) => [
      state.isCountingDown,
      state.startRecording,
      state.startCountingDown,
    ]
  );
  ...
  function beep(playbackRate: number = 1) {
    var snd = new Audio(
  ...
  function screenShot() {
    var snd = new Audio("/sounds/iphone-screenshot.mp3");
    snd.play();
  }
